package com.ValidateGetRequestWithParam;
...
public class ValidateGetWithParamSD {
	...
	@Then("validate title {string} and pages {string} of the book")
	public void validate_title_and_pages_of_the_book(String title, String pages) {
